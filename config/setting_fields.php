    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'value' => 'Bank Sampah Desa', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'string', // data type, string, int, boolean
                ...
                'class' => '', // any class for input
                'value' => '<a href="https://github.com/aridwi321/">Built in Indonesia</a>', // default value if you want
            ],
            [
    ...
    'meta' => [
        ...
        'elements' => [
            ...
            [
                ...
                'rules' => '', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '@ariwi321', // default value if you want
            ],
        ],
