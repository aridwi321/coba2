...
use Modules\Article\Http\Requests\Backend\InputRequest;
...
class InputController extends Controller
{
    ...
    {
    // Page Title
    $this->module_title = 'Inputs';

    // module name
    $this->module_name = 'inputs';

    // directory path of the module
    $this->module_path = 'inputs';

    // module icon
    $this->module_icon = 'fas fa-file-alt';

    // module model name, path
    $this->module_model = "Modules\Article\Entities\Input";
    }
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id','user_name', 'category_name', 'weight', 'updated_at', 'published_at');
    ...
    public function create()
    {
        ...
        return view("article::backend.$module_name.create",
                compact('module_title', 'module_name', 'module_icon', 'module_action', 'module_name_singular', 'categories','users'));
    }
    ...
    public function store(InputRequest $request)
    {
        ...
        $module_model::insert($insert_data);
    ...
    public function edit($id)
    {
        ...
        compact('categories','users','module_title', 'module_name', 'module_icon', 'module_name_singular', 'module_action', "$module_name_singular"));
    }
